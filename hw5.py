...
def sv_tree(trunk_length, levels):
    """creates a fractal tree with where each set of branches is half the length of the one that came before it and goes on for the number of levels of recursion."""
